...
namespace StudentResultManagement.Views.Admin
{
    public partial class Students : System.Web.UI.Page
    {
        ...
        {
            string Query = "Select StUsn as [Roll Number], StName as [Student Name], FName as [Father's Name], StDOB as [Student D.O.B], StAdd as Address, StPhone as Phone, StGen as Gender from StudentTbl";
        ...
        protected void EditBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Con.Setdata(Query);
                ShowStudents();
                ErrMsg.InnerText = "Student Update!!!";
                UsnTb.Value = "";
                NameTb.Value = "";
                FNameTb.Value = "";
